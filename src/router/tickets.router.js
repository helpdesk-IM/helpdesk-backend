...
const { postTickets, createTicket, getAllTickets, postTicketAttachment, getTicketsByClientId, updateTicket, postTicketAttachmentFtp, addCommentToTicket, updateAdminStatus, updateStatus, updateClientPriority, clientNotificationFalse, adminNotificationFalse, updateTicketTypeAndSubType, asignedTo } = require('../controller/tickets.controller.js');
...
router.put("/update-ticket-type/:ticketNumber", updateTicketTypeAndSubType)
router.put("/update-assigned-to/:ticketNumber", asignedTo)
